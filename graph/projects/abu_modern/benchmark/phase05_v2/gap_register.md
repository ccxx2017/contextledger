...
- invalidation 分离: precision 差值=`0.500`，recall 差值=`0.474`；这是当前两基线唯一明确发生分离的指标族
...
### invalidation_by_tag
- full: P/R=`1.000/0.615`，TP/FP/FN=`8/0/5`
- partial: P/R=`0.000/0.000`，TP/FP/FN=`0/2/2`
- conditional: P/R=`0.000/0.000`，TP/FP/FN=`0/2/2`
- revival: P/R=`0.500/0.167`，TP/FP/FN=`1/1/5`
- alias_trap: P/R=`1.000/NA`，TP/FP/FN=`0/0/0`
- provenance_conflict: P/R=`0.000/0.000`，TP/FP/FN=`0/1/1`
