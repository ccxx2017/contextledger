...
- invalidation 是当前唯一明确分离的指标族：precision 差值=`0.609`，recall 差值=`0.737`。
...
- full: P=`1.000` / R=`1.000` (TP/FP/FN=`13/0/0`; pred/gold=`13/13`)
- partial: P=`0.000` / R=`0.000` (TP/FP/FN=`0/2/2`; pred/gold=`2/2`)
- conditional: P=`0.000` / R=`0.000` (TP/FP/FN=`0/2/2`; pred/gold=`2/2`)
- revival: P=`0.833` / R=`0.833` (TP/FP/FN=`5/1/1`; pred/gold=`6/6`)
- alias_trap: P=`1.000` / R=`NA` (TP/FP/FN=`0/0/0`; pred/gold=`0/0`)
- provenance_conflict: P=`0.500` / R=`1.000` (TP/FP/FN=`1/1/0`; pred/gold=`2/1`)
